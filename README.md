<div align="center">
  ...
  <h3 align="center">SaaS App - AI Teaching Companion Platform</h3>

   <div align="center">
     A modern SaaS application built with Next.js that provides AI-powered teaching companions for personalized learning experiences. 
    </div>
</div>
...
```bash
git clone https://github.com/Anshul-04/lms_saas_app.git
cd lms_saas_app
```
