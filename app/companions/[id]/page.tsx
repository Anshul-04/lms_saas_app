...
const CompanionSession = async ({params }: CompanionSessionPageProps) => {
  ...
  return (
    <main>
      ...
      {/** Display the companion session Header */}
      <article className='flex rounded-border justify-between p-6 max-md:flex-col'>        
        
        <div className="flex items-center gap-2">

          {/** Display the subject icon and name of the companion */}          
          ...
          {/** Display the companion's name, subject badge, and topic */}
        ...
        {/** Display the companion's  duration */}
